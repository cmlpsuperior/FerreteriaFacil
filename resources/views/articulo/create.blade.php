...
<div class="container">
  ...
  <div class="row">
    <div class="col s12 blue-text">
      <h5>Registrar nuevo articulo</h5>
    </div>
  </div>
        ...
        <div class="card">
          ...
          <div class="card-content">
            ...
            <div class="row">
              ...
              <div class="input-field col s6">
                <select name="idUnidadMedida">                          
                  ...
                  <option value="{{$unidad->idUnidadMedida}}" @if ($unidad->idUnidadMedida == old('idUnidadMedida') ) selected @endif>{{$unidad->nombre}}</option>
                  @endforeach
                </select>
            ...
            <div class="row">
              ...
              <div class="input-field col s6">
                <input id="precioBase" type="number" min="0" step="0.01" class="validate" required value="{{ old('precioBase') }}" name="precioBase">
